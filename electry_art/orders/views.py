...
# class StripePaymentSuccessView(LoginRequiredMixin, View):
#     template_name = "orders/stripe_payment_success.html"
#
#
#     def get(self, request):
...
#         if not session_id:
#             log.info(
#                 "STRIPE_SUCCESS_PAGE_MISSING_SESSION_ID user_id=%s request_id=%s",
#                 actor_id,
#                 rid,
#             )
#             audit_event(
...
#
#             log.info(
#                 "STRIPE_SUCCESS_PAGE_OPENED order_id=%s serial=%s session_id=%s user_id=%s request_id=%s",
#                 order.pk,
#                 order.order_serial_number,
#                 session_id,
#                 actor_id,
...
#         except stripe.error.StripeError:
#             log.exception(
#                 "STRIPE_SUCCESS_PAGE_SESSION_RETRIEVE_FAILED user_id=%s request_id=%s session_id=%s",
#                 actor_id,
#                 rid,
#                 session_id,
#             )
